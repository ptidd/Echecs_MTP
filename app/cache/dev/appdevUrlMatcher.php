...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // _index
        if (0 === strpos($pathinfo, '/page') && preg_match('#^/page(?:/(?<name>[^/]+))?$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Echecs\\pageBundle\\Controller\\PageController::indexAction',  'name' => 'Accueil',)), array('_route' => '_index'));
        }

        // _articles_cat
        if (0 === strpos($pathinfo, '/categorie') && preg_match('#^/categorie/(?<name>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Echecs\\pageBundle\\Controller\\ArticleController::articlesByCatAction',)), array('_route' => '_articles_cat'));
        }

        // _detail_article
        if (0 === strpos($pathinfo, '/article') && preg_match('#^/article/(?<id>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Echecs\\pageBundle\\Controller\\ArticleController::showAction',)), array('_route' => '_detail_article'));
        }

        // _create_article
        if (rtrim($pathinfo, '/') === '/ajouter-article') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', '_create_article');
            }

            return array (  '_controller' => 'Echecs\\pageBundle\\Controller\\ArticleController::createAction',  '_route' => '_create_article',);
        }
